...
export default function() {
  ...
  while (board.length < 3) {
    ...
    board.push({
      name: `Biodome ${i}`,
      id: `board-${i}`,
      text: `Spend 10 steel and ${3*i} plants to increase oxygen 1 step`,
      afterBuildText: '',
      placed: false,
      buildable: true,
      actions: [
  ...
  while (board.length < 5) {
    ...
    board.push({
      name: `Heat Driller`,
      id: `board-heat-${i}`,
      text: 'Spend 10 steel to build a drill that increases the temperature 1 step every year',
      afterBuildText: 'Increases the Temperature 1 step every year.',
      placed: false,
      buildable: true,
      actions: [
        {
  ...
  while (board.length < 9) {
    ...
    board.push({
      name: `City`,
      id: `board-city${i}`,
      text: 'Spend 3 Titanium to build a city that grants 5 megacredit production and 2 energy production',
      placed: false,
      buildable: true,
      actions: [
        {
  ...
  return {
    ...
    winConditions: {
      [TYPES.CONDITION_TEMPERATURE]: 10,
      [TYPES.CONDITION_OXYGEN]: 3
    },
    yearlyActions: [],
    production: {
